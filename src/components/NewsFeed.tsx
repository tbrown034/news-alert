...
export const NewsFeed = memo(function NewsFeed({
  ...
  const displayPosts = isFiltered ? filteredItems.length : getTabCount('all');
    ...
    <div className="flex flex-col w-full max-w-4xl mx-auto">
      ...
      <div className="relative z-10 px-3 sm:px-4 py-2.5 bg-background-card/80 backdrop-blur-sm border-b border-border-light rounded-t-xl">
          ...
          <div className="pb-2">
            ...
            {/* Loading indicator */}
            {isPending && (
              <span className="ml-3 inline-flex items-center gap-2 text-xs text-foreground-muted" aria-live="polite">
