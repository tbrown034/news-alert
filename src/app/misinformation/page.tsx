...
export default function MisinformationGuidePage() {
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        {/* Core Principle */}
        <section className="bg-background-card rounded-2xl border border-border-card overflow-hidden">
          ...
          <div className="px-6 py-6 space-y-4">
            <p className="text-2xl font-semibold text-foreground text-center py-4">
        ...
        <section className="bg-background-card rounded-2xl border border-border-card overflow-hidden">
          ...
          <div className="px-6 py-6 space-y-6 text-foreground-muted">
            <p>
              <strong className="text-foreground">If a post makes you feel intense emotion, pause.</strong>
            ...
            <div className="bg-background-secondary rounded-xl p-4 space-y-3">
              <p className="font-medium text-foreground">Ask yourself:</p>
          ...
          <div className="px-6 py-6 space-y-6 text-foreground-muted">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-background-secondary rounded-xl">
                <h3 className="font-semibold text-foreground mb-2">Primary vs Secondary Sources</h3>
                <p className="text-sm">
              ...
              <div className="p-4 bg-background-secondary rounded-xl">
                <h3 className="font-semibold text-foreground mb-2">Step 1: Check Where It Came From</h3>
              ...
              <div className="p-4 bg-background-secondary rounded-xl">
                <h3 className="font-semibold text-foreground mb-2">Step 2: Evaluate Credibility</h3>
        ...
        <section className="bg-background-card rounded-2xl border border-border-card overflow-hidden">
          ...
          <div className="px-6 py-6 space-y-4 text-foreground-muted">
            <p>
        ...
        <section className="bg-background-card rounded-2xl border border-border-card overflow-hidden">
          ...
          <div className="px-6 py-6 space-y-4 text-foreground-muted">
            <div className="space-y-4">
              <div className="p-4 bg-background-secondary rounded-xl">
                <h3 className="font-semibold text-foreground mb-1">Decontextualization</h3>
                <p className="text-sm">
              ...
              <div className="p-4 bg-background-secondary rounded-xl">
                <h3 className="font-semibold text-foreground mb-1">Firehose of Falsehood</h3>
                <p className="text-sm">
              ...
              <div className="p-4 bg-background-secondary rounded-xl">
                <h3 className="font-semibold text-foreground mb-1">Amplification Networks</h3>
                <p className="text-sm">
              ...
              <div className="p-4 bg-background-secondary rounded-xl">
                <h3 className="font-semibold text-foreground mb-1">Kernel of Truth</h3>
                <p className="text-sm">
              ...
              <div className="p-4 bg-background-secondary rounded-xl">
                <h3 className="font-semibold text-foreground mb-1">&quot;Just Asking Questions&quot;</h3>
                <p className="text-sm">
          ...
          <div className="px-6 py-6 space-y-4 text-foreground-muted">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 bg-background-secondary rounded-lg hover:bg-border-light transition-colors"
              >
                <p className="font-medium text-foreground">Google Reverse Image Search</p>
                <p className="text-xs text-foreground-light">Find where images originated</p>
              </a>
              <a
                ...
                className="p-3 bg-background-secondary rounded-lg hover:bg-border-light transition-colors"
              >
                <p className="font-medium text-foreground">Snopes</p>
                <p className="text-xs text-foreground-light">Fact-checking database</p>
              </a>
              <a
                ...
                className="p-3 bg-background-secondary rounded-lg hover:bg-border-light transition-colors"
              >
                <p className="font-medium text-foreground">Wayback Machine</p>
                <p className="text-xs text-foreground-light">See what pages said originally</p>
              </a>
              <a
                ...
                className="p-3 bg-background-secondary rounded-lg hover:bg-border-light transition-colors"
              >
                <p className="font-medium text-foreground">Bellingcat Toolkit</p>
                <p className="text-xs text-foreground-light">OSINT verification resources</p>
              </a>
            </div>
          </div>
        </section>
          ...
          <div className="px-6 py-6 space-y-4 text-foreground-muted">
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground">Diversify your sources</p>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground">Slow down before sharing</p>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground">Follow corrections</p>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground">Be willing to be wrong</p>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground">Take breaks</p>
        ...
        {/* Final Note */}
        <section className="bg-background-secondary rounded-2xl border border-border-card p-6 text-center">
