...
function DemoBar({ label, multiplier, level }: { label: string; multiplier: number; count: number; baseline: number; level: 'normal' | 'elevated' | 'critical' }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <div className="w-14 text-right text-[11px] font-medium text-foreground-light shrink-0">
        {label}
      </div>
      <div className="flex-1 relative h-2.5 bg-background-secondary rounded-full overflow-hidden">
        <div
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <section className="py-4 sm:py-6">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold text-foreground mb-2 tracking-tight">
            Pulse
          </h2>
        ...
        <section className="bg-background-card rounded-xl border border-border-card overflow-hidden">
          <div className="px-5 sm:px-6 py-5 border-b border-border-card">
          ...
          <div className="px-5 sm:px-6 py-5 space-y-5 text-foreground-muted">
            ...
            <div className="bg-background-secondary rounded-lg border border-border-light p-4 space-y-2">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-semibold text-foreground">Feed Activity</span>
              ...
              <div className="flex items-center gap-2 -mt-0.5">
                ...
                <div className="flex-1 relative">
                  <div
                    className="text-[9px] text-foreground-light leading-none"
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center gap-3 p-2.5 rounded-lg bg-background-secondary border border-border-light">
                <span className="w-2 h-2 rounded-full bg-emerald-500 shrink-0" />
                <span className="text-foreground">Normal</span>
                <span className="ml-auto font-mono text-xs text-foreground-light">Below 2.5×</span>
              </div>
            </div>
        ...
        <section className="bg-background-card rounded-xl border border-border-card overflow-hidden">
          ...
          <div className="px-5 sm:px-6 py-5 space-y-4 text-foreground-muted">
            <p className="text-sm leading-relaxed">
              650+ sources across Bluesky, RSS, Telegram, Mastodon, Reddit, and YouTube.
            ...
            <div className="flex flex-wrap gap-2">
              {['Breaking News', 'Earthquakes', 'Wildfires', 'Severe Weather', 'Internet Outages', 'Travel Advisories'].map((item) => (
                <span key={item} className="px-3 py-1 bg-background-secondary text-foreground-light text-xs rounded-full border border-border-light">
                  {item}
                </span>
              ))}
            </div>
            ...
            <Link
              href="/sources"
              className="inline-flex items-center text-sm font-medium text-elevated hover:underline"
            >
              Browse all sources
          ...
          <div className="px-5 sm:px-6 py-5">
            ...
            <div className="flex flex-wrap gap-2">
              <a
                ...
                className="flex items-center gap-2 px-3.5 py-2 bg-background-secondary hover:bg-border-light rounded-lg transition-colors border border-border-light"
              >
        ...
        <section className="bg-background-card rounded-xl border border-border-card overflow-hidden">
          ...
          <div className="px-5 sm:px-6 py-5 space-y-4 text-sm text-foreground-muted leading-relaxed">
            <div>
              <h3 className="font-medium text-foreground mb-1">Sources</h3>
              <p>
                Pulse pulls from 650+ sources — wire services, OSINT analysts, journalists,
            ...
            <div>
              <h3 className="font-medium text-foreground mb-1">AI-generated content</h3>
              <p>
            ...
            <div>
              <h3 className="font-medium text-foreground mb-1">Work in progress</h3>
              <p>
            ...
            <div>
              <h3 className="font-medium text-foreground mb-1">Report issues</h3>
              <p>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-elevated hover:underline"
                >
                  GitHub
                </a>{' '}
                or reach out on{' '}
        ...
        {/* Media Literacy */}
        <section className="bg-background-card rounded-xl border border-border-card overflow-hidden">
          <Link href="/misinformation" className="block p-5 sm:p-6 hover:bg-background-secondary transition-colors">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-lg bg-elevated-muted flex items-center justify-center flex-shrink-0">
                <ShieldCheckIcon className="w-5 h-5 text-elevated" />
              </div>
              <div className="flex-1">
                ...
                <span className="inline-flex items-center text-sm font-medium text-elevated mt-2">
                  Read the guide
                  <svg className="w-3.5 h-3.5 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
