...
describe('calculateRegionActivity', () => {
  it('should return activity for all 5 tracked regions', () => {
    const items = makeItems('us', 5);
    const activity = calculateRegionActivity(items);
  ...
  it('should return correct counts per region', () => {
    const items = [
      ...makeItems('us', 10),
  ...
  it('should always show NORMAL for excluded regions (LATAM, Asia)', () => {
  ...
  it('should have positive baselines for all regions', () => {
    const activity = calculateRegionActivity([]);
  ...
  it('should set vsNormal correctly', () => {
    const activity = calculateRegionActivity([]);
  ...
  it('should not have a breaking field in the response', () => {
    const activity = calculateRegionActivity(makeItems('us', 5));
  ...
  it('should calculate percentChange correctly', () => {
    const items = makeItems('us', 10);
    const activity = calculateRegionActivity(items);
  ...
  it('should require both multiplier AND count thresholds for elevated', () => {
    ...
    const activity = calculateRegionActivity(makeItems('us', 15));
